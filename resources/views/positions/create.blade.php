                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('allocation') is-invalid @enderror" id="allocation" name="allocation" required>
                                    ...
                                    <option value="one-person" {{old('allocation')=='one-person' ? 'selected':''}}>Para una persona</option>
                                    <option value="several-people"  {{old('allocation')=='several-people' ? 'selected':''}}>Para varias personas</option>
                                </select>
