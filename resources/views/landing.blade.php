                                    ...
                                    <li>
                                        <div class="event-content">
                                            ...
                                            <div class="event-date">
                                                <span>
                                                    {{$event->additional_data['range_date']['start_date']}}
                                                    
                                                    @if ($event->additional_data['range_date']['end_date'])
                                                    al {{$event->additional_data['range_date']['end_date']}}
                                                    @endif
                                                </span>
                                                <span>
                                                    {{$event->additional_data['range_date']['start_time']}}

                                                    @if ($event->additional_data['range_date']['end_time'])
                                                    - {{$event->additional_data['range_date']['end_time']}}
                                                    @endif
                                                </span>
                                            </div>
                                        </div>
