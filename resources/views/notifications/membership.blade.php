...
<div class="row">
    <div class="col">
       <p>Lista de notificaciones de afiliación</p>
    </div>
</div>
<div class="row">
    <div class="col">
                                ...
                                @foreach ($all_membership_notifications as $notification)
                                    <tr>
                                        ...
                                        <td width='10px'>
                                            ...
                                            <a href="{{ route('membershipReport.membership', [$notification->data['neighbor']['id'], $notification->id])}}" class="btn btn-info">Ver</a>
